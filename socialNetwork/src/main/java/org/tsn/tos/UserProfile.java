...
public class UserProfile extends BaseTransferObject
{
	...
	String						tweeeterID				= null;
	String						googleID				= null;
	int							educationID				= Integer.MIN_VALUE;
	int							occupationID			= Integer.MIN_VALUE;
	int							securityQuestionId_1	= Integer.MIN_VALUE;
	int							securityQuestionId_2	= Integer.MIN_VALUE;
	int							securityQuestionId_3	= Integer.MIN_VALUE;
	int							securityQuestionId_4	= Integer.MIN_VALUE;
	int							securityQuestionId_5	= Integer.MIN_VALUE;
	...
	List<SecurityAnswer>		securityAnwers			= null;
