	...
	<div class="four_clum">
    	<div class="container">
            ...
            <div class="socialIcon">
                  <div class="cols-4">
                  <img src="<c:url value="/images/facebook.png" />"  alt="facebook" >
                  </div>
                  <div class="cols-4"><img src="<c:url value="/images/google-plus.png"/>"  alt="google plus" /></div>
                  <div class="cols-4"><img src="<c:url value="/images/twitter.png" />"  alt="twitter" /></div>
                  <div class="cols-4-last"><img src="<c:url value="/images/tube.png" />" alt="youtube" /></div>
                </div>
            </div>
            <div class="clear"></div>
        </div>
